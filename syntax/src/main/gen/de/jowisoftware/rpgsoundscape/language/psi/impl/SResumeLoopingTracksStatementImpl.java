...
public class SResumeLoopingTracksStatementImpl extends ASTWrapperPsiElement implements SResumeLoopingTracksStatement {

  public SResumeLoopingTracksStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitResumeLoopingTracksStatement(this);
  }
