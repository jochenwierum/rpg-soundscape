...
public class SCategorizedInImpl extends ASTWrapperPsiElement implements SCategorizedIn {

  public SCategorizedInImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitCategorizedIn(this);
  }
