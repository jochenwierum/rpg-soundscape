...
public class SPauseThisTrackImpl extends ASTWrapperPsiElement implements SPauseThisTrack {

  public SPauseThisTrackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitPauseThisTrack(this);
  }
