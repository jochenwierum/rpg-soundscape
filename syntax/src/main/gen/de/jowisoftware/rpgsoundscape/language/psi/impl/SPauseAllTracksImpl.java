...
public class SPauseAllTracksImpl extends ASTWrapperPsiElement implements SPauseAllTracks {

  public SPauseAllTracksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitPauseAllTracks(this);
  }
