...
public class SPauseAllOtherTracksImpl extends ASTWrapperPsiElement implements SPauseAllOtherTracks {

  public SPauseAllOtherTracksImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitPauseAllOtherTracks(this);
  }
