...
public class SDoNothingStatementImpl extends ASTWrapperPsiElement implements SDoNothingStatement {

  public SDoNothingStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitDoNothingStatement(this);
  }
