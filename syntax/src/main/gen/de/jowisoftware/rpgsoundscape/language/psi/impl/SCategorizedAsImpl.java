...
public class SCategorizedAsImpl extends ASTWrapperPsiElement implements SCategorizedAs {

  public SCategorizedAsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SVisitor visitor) {
    visitor.visitCategorizedAs(this);
  }
